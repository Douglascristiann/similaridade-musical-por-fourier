# -*- coding: utf-8 -*-
"""
Wrapper simples com cache para Shazam.
Se shazamio não estiver instalado/funcionando, retorna None.
"""
...
def recognize_with_cache(path: Path, prefer_shazam_first: bool = False) -> RecResult | None:
