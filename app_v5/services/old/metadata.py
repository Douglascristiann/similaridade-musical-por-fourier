...
# =======================================================================
# CORREÇÃO: Função renomeada de '_parse_title_tokens' para 'parse_title_tokens'
# =======================================================================
def parse_title_tokens(text: str) -> tuple[Optional[str], Optional[str], Optional[str]]:
    if not text:
